...
import com.square.pos.model_life.LifePremiumQuote;
...
public class LifeAdapter
    ...
    @NonNull
    @Override
    public LifeAdapter.PolicyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LifeAdapter.PolicyViewHolder holder, final int position) {
