...
public class LeadAdapter extends RecyclerView.Adapter<LeadAdapter.PolicyViewHolder> {
    ...
    private LeadAdapter.OnViewLead onLeadViewListener;
    ...
    public LeadAdapter(Context mContext, ArrayList<Lead> agentPolicyList) {
        ...
        if (mContext instanceof LeadAdapter.OnViewLead) {
            onLeadViewListener = (LeadAdapter.OnViewLead) mContext;
        }
    }

    @NonNull
    @Override
    public LeadAdapter.PolicyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_lead, parent, false);

        return new LeadAdapter.PolicyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LeadAdapter.PolicyViewHolder holder, final int position) {
