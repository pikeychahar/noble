...
import com.square.pos.model_crm.Cancellation;
 ...
 */
public class CancellationAdaptor extends RecyclerView.Adapter<CancellationAdaptor.ViewHolder> {
    ArrayList<Cancellation> claimList;
    Context mContext;
    OnDownloadClickListener downloadClickListener;
    OnCreateClaimListener createClaimListener;


    public CancellationAdaptor(Context mContext, ArrayList<Cancellation> claimList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        Cancellation policy = claimList.get(position);
