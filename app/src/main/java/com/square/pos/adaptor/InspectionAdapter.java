...
public class InspectionAdapter extends RecyclerView.Adapter<InspectionAdapter.PolicyViewHolder> {
    ...
    public InspectionAdapter(Context mContext, ArrayList<Quotation> agentPolicyList) {
        ...
        if (mContext instanceof InspectionAdapter.OnProceedClick) {
            onProceedClick = (InspectionAdapter.OnProceedClick) mContext;
        }
    }

    @NonNull
    @Override
    public InspectionAdapter.PolicyViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                                 int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull InspectionAdapter.PolicyViewHolder holder,
                                 final int position) {
