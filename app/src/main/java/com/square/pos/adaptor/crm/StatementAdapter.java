...
public class StatementAdapter
    ...
    @NonNull
    @Override
    public StatementAdapter.EarnViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull StatementAdapter.EarnViewHolder holder, final int position) {
