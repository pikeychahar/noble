...
import com.square.pos.model_pos.Quotation;
...
public class QuotationAdapter extends RecyclerView.Adapter<QuotationAdapter.QuoteViewHolder> {
    ...
    private QuotationAdapter.OnProceedClick onProceedClick;


    public QuotationAdapter(Context mContext, ArrayList<Quotation> agentPolicyList) {
        this.policyList = agentPolicyList;
        this.mContext = mContext;
        if (mContext instanceof QuotationAdapter.OnProceedClick) {
            onProceedClick = (QuotationAdapter.OnProceedClick) mContext;
        }
    }

    @NonNull
    @Override
    public QuotationAdapter.QuoteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull QuotationAdapter.QuoteViewHolder holder, final int position) {
        try {
