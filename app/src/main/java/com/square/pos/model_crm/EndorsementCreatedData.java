...
public class EndorsementCreatedData {
    ...
    @SerializedName("endosmentId")
    @Expose
    private String endosmentId;
    ...
    public String getEndosmentId() {
        return endosmentId;
    }

    public void setEndosmentId(String endosmentId) {
        this.endosmentId = endosmentId;
    }
