...
import com.square.pos.adaptor.CustomAdapter;
import com.square.pos.adaptor.PremiumAdapter;
...
public class PremiumActivity extends AbstractActivity implements onRequestCompleteCallBackListener,
    ...
    public void OnBreakUpClicked(int position) {
        ...
        final androidx.recyclerview.widget.RecyclerView listAddOn = dialog.findViewById(R.id.listAddOn);
