...
public class InsuredMember4Activity extends AbstractActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insured_member4);
        ...
        if (isSpouse || isMother || isFather) {
            if (totalSon > 1) {
                lblInsuredMember.setText("Child2");
                ...
                lblInsuredMember.setText("Child2");
                edtDob.setText(mBundle.getString(AppUtils.CAL_DAUGHTER2, ""));
            } else lblInsuredMember.setText("Insured Member");
        } else if (totalDaughter > 0 && totalSon > 1) {
            lblInsuredMember.setText("Child3");
            edtDob.setText(mBundle.getString(AppUtils.CAL_DAUGHTER1, ""));
        } else if (totalDaughter > 1) {
            lblInsuredMember.setText("Child3");
            edtDob.setText(mBundle.getString(AppUtils.CAL_DAUGHTER2, ""));
        ...
        if (isValid()) {
            ...
            if (isFather || isMother || isSpouse)
                if ((totalDaughter + totalSon) > 3)
                    intent = new Intent(mContext, InsuredMember5Activity.class);
                else intent = new Intent(mContext, NomineeProposerActivity.class);
            else if ((totalDaughter + totalSon) > 4)
                intent = new Intent(mContext, InsuredMember5Activity.class);
