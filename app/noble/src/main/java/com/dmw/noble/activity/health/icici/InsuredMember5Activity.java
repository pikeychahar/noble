...
public class InsuredMember5Activity extends AbstractActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insured_member5);
        ...
        if (isSpouse || isMother || isFather) {
            ...
            lblInsuredMember.setText("Child4");
            edtDob.setText(mBundle.getString(AppUtils.CAL_DAUGHTER2, ""));
        }
...
//            progressdialog.show();
    ...
    public void onNextClick(View view) {
        if (isValid()) {
            ...
            if ((totalDaughter + totalSon) > 5)
                intent = new Intent(mContext, InsuredMember6Activity.class);
