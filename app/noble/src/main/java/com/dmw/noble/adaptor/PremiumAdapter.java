...
public class PremiumAdapter
    ...
    public PremiumAdapter(Context mContext, ArrayList<PremiumObj> agentPolicyList) {
        ...
        if (mContext instanceof OnPremiumBreakClickListener) {
            onPremiumBreakClickListener = (OnPremiumBreakClickListener) mContext;
        }
        if (mContext instanceof OnAddonClickListener) {
            onAddonClickListener = (OnAddonClickListener) mContext;
        }
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final PolicyViewHolder holder, final int position) {
