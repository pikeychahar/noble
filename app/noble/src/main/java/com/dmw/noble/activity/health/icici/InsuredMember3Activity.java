...
public class InsuredMember3Activity extends AbstractActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insured_member3);
        ...
        if (isSpouse || isMother || isFather) {
            ...
            edtDob.setText(mBundle.getString(AppUtils.CAL_SON2, ""));
        ...
        if (isValid()) {
            ...
            if (isFather || isMother || isSpouse)
                if ((totalDaughter + totalSon) > 2)
                    intent = new Intent(mContext, InsuredMember4Activity.class);
                else intent = new Intent(mContext, NomineeProposerActivity.class);
            else if ((totalDaughter + totalSon) > 3)
                intent = new Intent(mContext, InsuredMember4Activity.class);
