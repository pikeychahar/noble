...
public class FetchQuote {
    ...
    @SerializedName("policy_document_uplode")
    @Expose
    private String policyDocumentUplode;
    ...
    public String getPolicyDocumentUplode() {
        return policyDocumentUplode;
    }

    public void setPolicyDocumentUplode(String policyDocumentUplode) {
        this.policyDocumentUplode = policyDocumentUplode;
    }
