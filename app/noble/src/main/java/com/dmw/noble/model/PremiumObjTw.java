...
public class PremiumObjTw {
    ...
    public String getUnnamedPerson() {
        return unnamedPerson;
    }

    public void setUnnamedPerson(String unnamedPerson) {
        this.unnamedPerson = unnamedPerson;
    }
